...
export function MediaGrid({
  ...
  return (
    <List
      ...
      // на быстром свайпе список не успевает: клетка появляется ровно тогда,
      // когда её уже видно. Экран в каждую сторону стоит дёшево — клетки
      // переиспользуются, а не монтируются.
      drawDistance={height}
